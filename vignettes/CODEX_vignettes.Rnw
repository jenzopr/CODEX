...
Installation inforation is available \href{https://sites.google.com/a/cornell.edu/yuchaojiang/home/research/codex}{here}. The online Q\&A forum is availbale \href{https://groups.google.com/d/forum/codex_wes_cnv}{here}.
...
used to determine the stop point of segmentation).
\\
